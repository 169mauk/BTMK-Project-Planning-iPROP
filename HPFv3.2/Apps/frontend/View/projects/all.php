			...
			<table class="table table-hover table-fluid dataTable">
				...
				?>
					<tr>
						...
						<td class="text-right">
							<a title="Edit Project" href="<?= F::URLParams() ?>/edit/<?= $p->p_id ?>" class="btn btn-sm btn-warning">
								<span class="icon-edit"></span>
							</a>
						<?php
							if($_SESSION["role"]){
							?>
							<a title="Delete Project" href="<?= F::URLParams() ?>/delete/<?= $p->p_id ?>" class="btn btn-sm btn-danger">
			...
			<form action="" method="POST">
				<div class="row">
					<div class="col-md-6">
						...
						<?php
							foreach(sectors::list() as $d){
							?>
							<option value="<?= $d->s_id ?>"><?= $d->s_name ?></option>
							<?php
							}
						?>
						</select><br /><br />
			...
			<div class="row gutters">
				<?php
					...
					if(count($project) > 0){
						...
						$menus = ["Info", "Application", "Clients", "Subs", "Schedule", "Reports", "Maintenance", "EOT", "VO", "Users", "Board", "Issues", "Files", "Finish"];
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							...
							<div class="tab-content" id="">
								...
								switch($view){
									...
									case "Application":
										Page::Load("projects/edit/application");
									break;
									...
									case "Maintenance":
										Page::Load("projects/edit/maintenance");
									break;
