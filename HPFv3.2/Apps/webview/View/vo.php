								...
								<form action="" method="POST" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-md-4">
											Status:
											<?php
												$dep_id =  $_SESSION["department_id"][0];
												$role =  $_SESSION["user_department"][$dep_id];
									...
									<div class="row">
										<div class="col-md-4">
											Value (RM):
											<input type="text" class="form-control" placeholder="Value" name="v_value" value="<?= number_format($comp->v_value, 2) ?>" required/>
										</div>
									</div><br /><br />
									<div class="row">
										<div class="col-md-4">
