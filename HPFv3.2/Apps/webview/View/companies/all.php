						...
						?>
							<tr>
								...
								<td class="text-center">
									<a href="<?= F::URLParams() ?>/edit/<?= $c->c_id?>" class="btn btn-sm btn-warning">
										<span class="icon-plus2"></span> Edit
									</a>
									<a href="<?= F::URLParams() ?>/delete/<?= $c->c_id ?>" class="btn btn-sm btn-danger">
							...
							if(count($comp) > 0){
								...
								<form action="" method="POST" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="col-md-6">
											Email:
											<input type="text" class="form-control" placeholder="Email" name="c_email" value="<?= $comp->c_email ?>" required/><br />
										</div>
										<div class="col-md-4">
											Phone:
											<input type="text" class="form-control" placeholder="Phone" name="c_phone" value="<?= $comp->c_phone ?>" required/>
										</div>
										<div class="col-md-4">
											Reg No:
