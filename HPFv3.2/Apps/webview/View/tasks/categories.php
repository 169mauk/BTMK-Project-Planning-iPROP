...
switch(url::get(2)){
					...
					<table class="table table-hover table-fluid table-bordered dataTable">
						...
						?>
							<tr>
								...
								<td><?= $c->t_content ?></td>
								<td class="text-right">
									<a class="btn btn-sm btn-primary" href="<?= F::URLParams() ?>/edit/<?= $c->t_id ?>"><span class="icon-plus2"></span></a>
									<a class="btn btn-sm btn-danger" href="<?= F::URLParams() ?>/delete/<?= $c->t_id ?>"><span class="icon-trash"></span></a>
								</td>
							</tr>
						<?php
							}
	...
	case "edit":
		$t = task_category::getBy(["t_id" => url::get(3)]);
			if(count($t) > 0){
				$t = $t[0];
