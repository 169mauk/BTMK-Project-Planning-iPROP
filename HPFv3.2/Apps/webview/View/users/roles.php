					...
					<table class="table table-hover table-fluid table-bordered dataTable">
						...
						?>
							<tr>
								...
								<td class="text-right">
									<a class="btn btn-sm btn-primary" href="<?= F::URLParams() ?>/edit/<?= $c->r_id ?>"><span class="icon-plus2"></span></a>
									<a class="btn btn-sm btn-danger" href="<?= F::URLParams() ?>/delete/<?= $c->r_id ?>"><span class="icon-trash"></span></a>
								</td>
							</tr>
						<?php
							}
							...
							<form action="" method="POST">
								<div class="row">
									<div class="col-md-4">
										...
										Are you sure to delete this <?= $t->r_role ?> data? <br /><br />
